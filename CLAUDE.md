...
- Careers: "Life at RJB" (`#life-at-rjb`) and "Life Beyond the Jobsite" 9-tile grid added under the career info. All 9 tile photos are in `images/culture/` (900×900, compressed, EXIF stripped) — see the Careers section of `images/PHOTO-GUIDE.md`. A Life at RJB video will go below that intro later.
